...
@TableName("WESTERN_PRESCRIPTION")
public class WesternPrescription implements Serializable {
     ...
     * 抗菌药物等级代码
     */
    @TableField("ANTIBA_DRUGS_LEVEL")
    private String antibaDrugsLevel;

    /**
     * 抗菌药物等级
     */
    @TableField("ANTIBA_DRUGS_LEVEL_NAME")
    private String antibaDrugsLevelName;
