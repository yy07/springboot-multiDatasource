...
@TableName("PRE_OPERATION_SUMMARY")
public class PreOperationSummary implements Serializable {
     ...
     * 手术适应证
     */
    @TableField("OPERATIVE_INDICATION")
    private String operativeIndication;

    /**
     * 手术禁忌症
     */
    @TableField("OPERATION_CONTRAINDICATION")
