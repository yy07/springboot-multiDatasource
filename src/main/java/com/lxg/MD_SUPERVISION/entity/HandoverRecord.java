...
public class HandoverRecord implements Serializable {
     ...
     * 接班诊疗计划
     */
    @TableField("SUCC_ASSESSMENT_PLAN")
    private String succAssessmentPlan;
     ...
     * 交班者签名
     */
    @TableField("HANDOVER_SIG")
    private String handoverSig;

    /**
     * 接班日期时间
     */
    @TableField("SUCC_DATE")
    private LocalDateTime succDate;

    /**
     * 接班者签名
     */
    @TableField("SUCC_SIG")
    private String succSig;
