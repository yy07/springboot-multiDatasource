...
@TableName("H24_ADMISSION_DISCHARGE_RECORD")
public class H24AdmissionDischargeRecord implements Serializable {
     ...
     * 出院诊断-西医诊断
     */
    @TableField("OUTHOS_WEST_DIAG_DESC")
    private String outhosWestDiagDesc;

    /**
     * 出院诊断-西医诊断名称
     */
    @TableField("OUTHOS_WEST_DIAG_NAME")
    private String outhosWestDiagName;

    /**
     * 出院诊断-西医诊断编码
     */
    @TableField("OUTHOS_WEST_DIAG_CODE")
    private String outhosWestDiagCode;

    /**
     * 出院诊断-中医病名
     */
    @TableField("OUTHOS_TCM_DIS_DESC")
    private String outhosTcmDisDesc;

    /**
     * 出院诊断-中医病名名称
     */
    @TableField("OUTHOS_TCM_DIS_NAME")
    private String outhosTcmDisName;

    /**
     * 出院诊断-中医证候
     */
    @TableField("OUTHOS_SYNDROMES_DIS_DESC")
    private String outhosSyndromesDisDesc;

    /**
     * 出院诊断-中医病名代码
     */
    @TableField("OUTHOS_TCM_DIS_CODE")
    private String outhosTcmDisCode;

    /**
     * 出院诊断-中医证候名称
     */
    @TableField("OUTHOS_SYNDROMES_DIS_NAME")
    private String outhosSyndromesDisName;

    /**
     * 出院诊断-中医证候代码
     */
    @TableField("OUTHOS_SYNDROMES_DIS_CODE")
    private String outhosSyndromesDisCode;
     ...
     * 出院医嘱开立人签名
     */
    @TableField("OUTHOS_ADVIC_OPENER_SIG")
    private String outhosAdvicOpenerSig;

    /**
     * 出院医嘱开立日期时间
     */
    @TableField("OUTHOS_ADVIC_OPEN_DATE")
    private LocalDateTime outhosAdvicOpenDate;
